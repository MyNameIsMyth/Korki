...
const adminController = {
    // Авторизация администратора - ФИКСИРОВАННЫЕ ДАННЫЕ
    login: async (req, res) => {
        try {
            const { login, password } = req.body;

            console.log('Попытка входа администратора:', { login, password });
    ...
    getStats: async (req, res) => {
        try {
            console.log('Получение статистики администратором');
